const Tips = () => {
    return (
        <>
            <div className='mt-16 max-w-screen-xl px-4 pb-8 mx-auto lg:pb-24 lg:px-6 '>
                <div className='mt-5 bg-white p-5 rounded-md w-full lg:w-1/2 drop-shadow-lg mx-auto'>
